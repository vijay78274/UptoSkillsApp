...
import com.example.uptoskills.Adapters.skills_adapter_t2;
...
public class resume2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView xphone = findViewById(R.id.phone2);
        TextView xemail = findViewById(R.id.email2);
        TextView xaddress = findViewById(R.id.address2);
        ...
        rv = findViewById(R.id.skills_list);
        rv.setLayoutManager(new LinearLayoutManager(resume2.this));


        cax = new skills_adapter_t2();
        rv.setAdapter(cax);
        archievements = findViewById(R.id.archievements_list);
        archievements.setLayoutManager(new LinearLayoutManager(resume2.this));

        arc = new archievements_adapter();
        archievements.setAdapter(arc);

        education = findViewById(R.id.education_list);
        education.setLayoutManager(new LinearLayoutManager(resume2.this));

        edu = new education_adapter();
        education.setAdapter(edu);
        experience = findViewById(R.id.experience_list);
        experience.setLayoutManager(new LinearLayoutManager(resume2.this));

        exp = new experience_adapter();
        experience.setAdapter(exp);
        project = findViewById(R.id.project_list);
        project.setLayoutManager(new LinearLayoutManager(resume2.this));
