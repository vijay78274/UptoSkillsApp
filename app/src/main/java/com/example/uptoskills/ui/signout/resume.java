...
String name = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rv.setLayoutManager(new LinearLayoutManager(resume.this));
       ...
       archievements = findViewById(R.id.archivement_list);
        archievements.setLayoutManager(new LinearLayoutManager(resume.this));

        arc = new archievements_adapter();
        archievements.setAdapter(arc);

       education = findViewById(R.id.education_list);
        education.setLayoutManager(new LinearLayoutManager(resume.this));
        ...
        experience.setLayoutManager(new LinearLayoutManager(resume.this));
        ...
        project.setLayoutManager(new LinearLayoutManager(resume.this));
